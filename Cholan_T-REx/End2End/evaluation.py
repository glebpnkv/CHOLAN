...
if __name__ == '__main__':
    ...
    precision_output, recall_output, fscore_output = el_evaluation(target_list, predicted_list)

    print("Precision = %.1f" % precision_output, "\nRecall = %.1f" % recall_output, "\nF-Score = %.1f" % fscore_output)
